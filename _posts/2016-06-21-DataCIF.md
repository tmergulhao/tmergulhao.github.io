...
{% include figure.html class="complexity-graph cif" description="Grafo de complexidade da totalidade da CIF" caption="Grafo de complexidade da CIF" %}
...
{% include figure.html class="complexity-graph namespace-b" description="Grafo de complexidade da sessão Funções do corpo da CIF" caption="Grafo de complexidade da sessão Funções do corpo da CIF" %}
...
{% include figure.html class="complexity-graph namespace-s" description="Grafo de complexidade da sessão Estruturas do corpo da CIF" caption="Grafo de complexidade da sessão Estruturas do corpo da CIF" %}
...
{% include figure.html class="complexity-graph namespace-e" description="Grafo de complexidade da sessão Ambiente da CIF" caption="Grafo de complexidade da sessão Ambiente da CIF" %}
...
{% include figure.html class="complexity-graph namespace-d" description="Grafo de complexidade da sessão Participação da CIF" caption="Grafo de complexidade da sessão Participação da CIF" %}
